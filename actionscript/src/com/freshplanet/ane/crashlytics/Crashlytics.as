...
package com.freshplanet.ane.crashlytics
{
	...
	public class Crashlytics
	{
		...
		public static function crash():void
		{
			...
			{
				log("In order to force a crash on Android, you need to declare the following activity in your manifest: com.freshplanet.ane.crashlytics.activities.CrashActivity");
			}
		}
		...
		private static const EXTENSION_ID : String = "com.freshplanet.Crashlytics";
